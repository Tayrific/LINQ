...
namespace LINQWithDataSet.NorthwindDSTableAdapters {
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=WINDOWS-4QT2NDK;Initial Catalog=Northwind;User ID=sa;Password=11Jan02" +
...
SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, ReportsTo, PhotoPath FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
    ...
    public partial class Ten_Most_Expensive_ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(NorthwindDS.Ten_Most_Expensive_ProductsDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual NorthwindDS.Ten_Most_Expensive_ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            NorthwindDS.Ten_Most_Expensive_ProductsDataTable dataTable = new NorthwindDS.Ten_Most_Expensive_ProductsDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
    }
